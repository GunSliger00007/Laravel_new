...
<div class="container-fluid tm-mt-60">
    ...
    <div class="row tm-mb-74 tm-people-row">
        <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
            <img src="{{asset('assets/frontend/img/people-1.jpg')}}" alt="Image" class="mb-4 img-fluid">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
            <img src="{{asset('assets/frontend/img/people-2.jpg')}}" alt="Image" class="mb-4 img-fluid">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
            <img src="{{asset('assets/frontend/img/people-3.jpg')}}" alt="Image" class="mb-4 img-fluid">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
            <img src="{{asset('assets/frontend/img/people-4.jpg')}}" alt="Image" class="mb-4 img-fluid">
